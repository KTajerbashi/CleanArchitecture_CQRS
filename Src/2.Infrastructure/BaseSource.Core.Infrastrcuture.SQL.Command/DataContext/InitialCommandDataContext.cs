using BaseSource.Core.Infrastrcuture.SQL.Command.Common.Constants;
using BaseSource.Utilities.Scrutor;

namespace BaseSource.Core.Infrastrcuture.SQL.Command.DataContext;

public class InitialCommandDataContext : IScopedLifetime
{
    private readonly ILogger<InitialCommandDataContext> _logger;
    private readonly CommandDataContext _context;
    private readonly UserManager<UserIdentity> _userManager;
    private readonly RoleManager<RoleIdentity> _roleManager;

    public InitialCommandDataContext(
        ILogger<InitialCommandDataContext> logger,
        CommandDataContext context,
