...
using CleanArchitectureCQRS.Domain.Library.Catalogs.Events;
using System;
...
namespace CleanArchitectureCQRS.Domain.Library.Catalogs.Entities;


[Table("CatalogItems", Schema ="DBO")]
